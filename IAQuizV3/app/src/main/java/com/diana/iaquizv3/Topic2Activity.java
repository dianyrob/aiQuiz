...
public class Topic2Activity extends AppCompatActivity {
    String filepath = "https://firebasestorage.googleapis.com/v0/b/equiz-641f1.appspot.com/o/chapter2.pdf?alt=media&token=b66ba19d-9eed-4cad-b1e7-ec6d9083efec";
    String fileName="AITrainer_Chapter2.pdf";
    Intent i;
    ...
    public void option(View v) {
        switch(v.getId()){
            case R.id.logo:
                i = new Intent(Topic2Activity.this, MainActivity.class);
                startActivity(i);
                finish();
                break;
            case R.id.back:
