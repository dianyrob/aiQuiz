...
public class Quiz5Activity extends AppCompatActivity {
    ...
    int questions=0,totalQuestions=38;
    int questionsLimit=38;
    Intent i,modulos;
    int[] quest=new int[38];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = da.getUsername();
        if(name==null)
            qSet.requestName(Quiz5Activity.this);

        i=new Intent(Quiz5Activity.this, ScoreActivity.class);
    ...
    public void onBackPressed () {
        modulos=new Intent(Quiz5Activity.this, ModulosActivity.class);
