...
public class Topic4Activity extends AppCompatActivity {
    String filepath = "https://firebasestorage.googleapis.com/v0/b/equiz-641f1.appspot.com/o/chapter4.pdf?alt=media&token=f05fecdb-8f3f-4e99-adb4-ce3a39d89a6e";
    String fileName="AITrainer_Chapter4.pdf";
    Intent i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfView.fromAsset("chapter4.pdf")
    ...
    public void onBackPressed () {
        Intent intent = new Intent(Topic4Activity.this, ModulosActivity.class);
    ...
    public void option(View v) {
        switch(v.getId()){
            case R.id.logo:
                i = new Intent(Topic4Activity.this, MainActivity.class);
                startActivity(i);
                finish();
                break;
            case R.id.back:
